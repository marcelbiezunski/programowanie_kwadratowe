...
% Dobrą praktyką jest wybranie punktu, który spełnia ograniczenia (np. 0,0),
% chociaż algorytm poradzi sobie zazwyczaj nawet z punktem niedopuszczalnym.
x0 = [0; 0]; 
% Działanie active-set
options = optimoptions('quadprog', 'Algorithm', 'active-set', 'Display', 'iter');

% Dodajemy x0 jako 9. argument funkcji (przed options)
